...
YOUTUBE = [
    ...
    {"ids":["LibyaAlhadath.ly","LibyaAlhadathTV.ly"],"names":["Libya Alhadath","Libya Alhadath TV","LIBYA ALHADATH HD","قناة ليبيا الحدث"],"fallback_id":"LibyaAlhadath.ly","name":"Libya Alhadath TV","group":"Libye","url":"https://www.youtube.com/@libyaalhadath/live"},
